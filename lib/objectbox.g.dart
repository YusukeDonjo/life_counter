...
final _entities = <ModelEntity>[
  ModelEntity(
      id: const IdUid(1, 658532933909255608),
      name: 'LifeEvent',
      lastPropertyId: const IdUid(3, 6252239926952991140),
      flags: 0,
      properties: <ModelProperty>[
        ModelProperty(
            id: const IdUid(1, 459877906638886127),
            name: 'id',
            type: 6,
            flags: 1),
        ModelProperty(
            id: const IdUid(2, 5300990139479157253),
            name: 'title',
            type: 9,
            flags: 0),
        ModelProperty(
            id: const IdUid(3, 6252239926952991140),
            name: 'count',
            type: 6,
            flags: 0)
      ],
...
ModelDefinition getObjectBoxModel() {
  final model = ModelInfo(
      entities: _entities,
      lastEntityId: const IdUid(1, 658532933909255608),
